    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surfaceHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                mediaPlayer = MediaPlayer.create(VideoSurfaceViewActivity.this, Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.video_file2)); // Agrega tu archivo de video en la carpeta res/raw
